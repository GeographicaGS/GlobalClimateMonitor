 ...
 *  - <OpenLayers.Control>
 */
OpenLayers.Control.LayerSwitcherRadio =
  ...
  // DOM Elements
    ...
    redraw: function() {
        ...
        var aktLayer = (this.map.aktLayer) ? this.map.aktLayer : 0;
        ...
        for( var i = 0; i < layers.length; i++) {
            ...
            if (layer.displayInLayerSwitcher) {
                ...
                inputRadio.id = "input_aktLayer_" + layer.name;
                inputRadio.name = "input_aktLayer";
                inputRadio.type = "radio";
                inputRadio.value = i;
                inputRadio.checked = (aktLayer==i) ? true : false;
    ...
    onInputClickR: function(e) {
        ...
        if (!this.inputRadio.disabled) {
                ...
                this.layer.map.aktLayer=parseInt(this.inputRadio.value);
