...
var tour = new Tour({
  steps: [
  {
	...
	placement: 'left'
      ...
      {
    element: "#ctrl_sym",
    title: "Symbology tool",
    content: "Here you can switch between point/polygon symbols",
	animation: true,
	placement: 'left'
  },
      {
    ...
    content: "The map displays by default in Web Mercator projection. Click on the little map to launch the viewer in Plate Carrée projection. You will see the approximate scale at the bottom.",
	animation: true,
	placement: 'left'
  },
      {
