...
//KML placemark
					...
					var urlroot = 'http://www.globalclimatemonitor.org/geoserver/gcm/wms?FORMAT=application/vnd.google-earth.kml+xml&REQUEST=GetMap&SRS=epsg:4326&STYLES=' + style + '_kml&' ;
					var url = urlroot + 'LAYERS='+ layers + '&CQL_FILTER=' + filter + '&BBOX=' + BBOX + restoparams;
			window.open(url);
