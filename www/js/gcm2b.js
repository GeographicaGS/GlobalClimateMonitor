...
// Añadimos el panel al mapa
    ...
    world_limits = new OpenLayers.Layer.Vector("White background with limits", {
        ...
        protocol: new OpenLayers.Protocol.HTTP({
            url: "http://www.globalclimatemonitor.org/data/countries.geo.json",
